//Модифицируйте программу store_temps . cpp из упр. 2, включив в нее
//суффикс с для шкалы Цельсия и суффикс f для шкалы Фаренгейта.
//Затем модифицируйте программу temp_stats . cpp, чтобы перед записью в вектор она проверяла каждое показание и преобразовывала
//температуру в градусах Цельсия в градусы Фаренгейта. 
